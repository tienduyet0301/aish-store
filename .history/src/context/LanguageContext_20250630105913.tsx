...
type TranslationKey = 
  ...
  | 'products.filter.noProductsSimple'
  | 'products.filter.colorBlack'
  | 'products.filter.colorWhite'
  | 'products.filter.colorBlue'
  | 'products.filter.colorGrey'
  | 'products.filter.colorBeige'
  | 'products.filter.sizeM'
  | 'products.filter.sizeL'
  | 'products.filter.sizeXL'
  | 'products.filter.colorLabel'
  | 'products.filter.sizeLabel'
  | 'products.filter.selectHint'
  ...
  | 'product.pleaseSelectSize'
  | 'product.selectSizeBeforeAdding'
  | 'product.sizeGuide'
  | 'product.close'
  | 'product.unknownColor'
  | 'product.descriptionUnavailable'
  | 'product.detailsUnavailable'
  | 'product.category'
  | 'product.price'
  | 'product.inStock'
  | 'product.needHelp'
  ...
  // Collection
  | 'collection.acceptTheProblem'
  | 'collection.backToSummer'
  | 'collection.chillCalmDown';
...
const translations: Translations = {
  en: {
    ...
    'products.filter.noProductsSimple': 'No products found',
    'products.filter.colorBlack': 'Black',
    'products.filter.colorWhite': 'White',
    'products.filter.colorBlue': 'Blue',
    'products.filter.colorGrey': 'Grey',
    'products.filter.colorBeige': 'Beige',
    'products.filter.sizeM': 'M',
    'products.filter.sizeL': 'L',
    'products.filter.sizeXL': 'XL',
    'products.filter.colorLabel': 'Colour',
    'products.filter.sizeLabel': 'Size',
    'products.filter.selectHint': 'You can select several options at once.',
    ...
    'product.onlyLeft': 'Only {count} left in size {size}',
    'product.left': '{count} item(s) left',
    'product.sizeOutOfStock': 'Size {size} is out of stock',
    'product.pleaseSelectSize': 'Please select a size',
    'product.selectSizeBeforeAdding': 'Please select a size before adding to cart',
    'product.sizeGuide': 'Size guide',
    'product.close': 'Close',
    'product.unknownColor': 'Unknown color',
    'product.descriptionUnavailable': 'No description available.',
    'product.detailsUnavailable': 'No details available.',
    'product.category': 'Category',
    'product.price': 'Price',
    'product.inStock': 'In stock',
    'product.needHelp': 'Need help?',
    'product.selectSize': 'PLEASE SELECT SIZE',
    'product.selectSizeDescription': 'You need to select a size before adding the product to cart',
    'product.closeButton': 'CLOSE',
    ...
    'product.detailsLabel': 'DETAILS:',
    'product.helpButton': 'NEED HELP?',
    // Cart
    ...
    'collection.acceptTheProblem': 'Accept the Problem',
    'collection.backToSummer': 'Back to Summer',
    'collection.chillCalmDown': 'Chill, Calm Down',
  },
  vi: {
    // Common
    ...
    'products.filter.noProductsSimple': 'Chưa có sản phẩm bạn tìm kiếm',
    'products.filter.colorBlack': 'Đen',
    'products.filter.colorWhite': 'Trắng',
    'products.filter.colorBlue': 'Xanh',
    'products.filter.colorGrey': 'Xám',
    'products.filter.colorBeige': 'Be',
    'products.filter.sizeM': 'M',
    'products.filter.sizeL': 'L',
    'products.filter.sizeXL': 'XL',
    'products.filter.colorLabel': 'Màu sắc',
    'products.filter.sizeLabel': 'Kích thước',
    'products.filter.selectHint': 'Bạn có thể chọn nhiều tuỳ chọn cùng lúc.',
    'products.filter.close': 'Đóng',
    ...
    'product.addedToCart': 'Đã thêm vào giỏ hàng thành công',
    'product.onlyLeft': 'Chỉ còn {count} sản phẩm size {size}',
    'product.left': 'Còn {count} sản phẩm',
    'product.sizeOutOfStock': 'Size {size} đã hết hàng',
    'product.pleaseSelectSize': 'Vui lòng chọn size',
    'product.selectSizeBeforeAdding': 'Vui lòng chọn size trước khi thêm vào giỏ hàng',
    'product.sizeGuide': 'Hướng dẫn chọn size',
    'product.close': 'Đóng',
    'product.unknownColor': 'Không xác định màu',
    'product.descriptionUnavailable': 'Chưa có mô tả cho sản phẩm này.',
    'product.detailsUnavailable': 'Chưa có thông tin chi tiết.',
    'product.category': 'Danh mục',
    'product.price': 'Giá',
    'product.inStock': 'Còn hàng',
    'product.needHelp': 'Cần hỗ trợ?',
    'product.selectSize': 'VUI LÒNG CHỌN SIZE',
    'product.selectSizeDescription': 'Bạn cần chọn size trước khi thêm sản phẩm vào giỏ hàng',
    'product.closeButton': 'ĐÓNG',
    'product.itemsLeft': 'Còn lại {count} sản phẩm',
    'product.outOfStock': 'Hết hàng',
    'product.addToCartButton': 'THÊM VÀO GIỎ HÀNG',
    'product.sizeGuideTitle': 'HƯỚNG DẪN CHỌN SIZE',
    'product.quantityLabel': 'SỐ LƯỢNG:',
    'product.detailsLabel': 'CHI TIẾT:',
    'product.helpButton': 'CẦN GIÚP ĐỠ?',
    // Cart
    ...
    'care.help.title': 'CHÚNG TÔI CÓ THỂ GIÚP GÌ CHO BẠN?',
    ...
    'return.help.title': 'CHÚNG TÔI CÓ THỂ GIÚP GÌ CHO BẠN?',
    // About Us
    'about.title': 'VỀ AISH',
    ...
    'collection.acceptTheProblem': 'Chấp nhận vấn đề',
    'collection.backToSummer': 'Quay lại mùa hè',
    'collection.chillCalmDown': 'Thư giãn, Bình tĩnh',
  }
};
