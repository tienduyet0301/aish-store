...
const translations: Translations = {
  en: {
    ...
    'product.selectSizeBeforeAdding': 'You need to select a size before adding to cart',
  ...
  vi: {
    ...
    'product.selectSizeBeforeAdding': 'Bạn cần chọn size trước khi thêm sản phẩm vào giỏ hàng',
    'product.sizeGuide': 'Hướng dẫn chọn size',
    'product.close': 'Đóng',
    'product.unknownColor': 'Không xác định',
    // Cart
