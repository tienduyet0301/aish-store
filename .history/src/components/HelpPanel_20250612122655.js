      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 w-full md:w-1/2 h-full bg-white z-50 overflow-y-auto"
          >
            <div className="relative p-6 md:p-12">
              {/* Close button */}
              <button
                onClick={onClose}
                className="absolute top-6 right-6 md:top-8 md:right-8 text-black hover:opacity-70"
              >
                ...
                <div className="flex flex-col space-y-1">
                  <div className="flex items-start space-x-6 p-4 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a 
                        href="https://www.instagram.com/aish.aish.vn/"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ 
                          fontSize: "0.85em",
