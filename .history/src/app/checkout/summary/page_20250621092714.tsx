...
export default function OrderSummary({ shippingFee = 0, provinceName = "" }) {
    ...
    <div style={styles.rightSection}>
      <div style={styles.orderSummary}>
        ...
        <div style={styles.orderTotals}>
          ...
          <div style={styles.orderTotalRow}>
            <span>Shipping</span>
            <span>{provinceName ? `${shippingFee.toLocaleString('vi-VN')} VND` : "Shipping fee will be calculated at checkout"}</span>
          </div>
          {provinceName && (
            <div style={{
              fontSize: "0.8em",
