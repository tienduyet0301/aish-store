        ...
        <div style={styles.orderTotals}>
          {(order.promoAmount !== undefined && order.promoAmount > 0) || promoAmount > 0 ? (
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5a2 2 0 012 2v5a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2zm0 0v11m0-11h11" /></svg>
                <span>Xem voucher của Aish</span>
              </button>
              {promoMessage && (
                <p style={{
                  fontSize: "0.7em",
