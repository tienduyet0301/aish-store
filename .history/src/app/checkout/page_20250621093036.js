...
export default function Checkout() {
  ...
  const order = {
    ...
    shipping: "Shipping fee will be calculated at checkout",
  ...
  // Function to update shipping info from shipping page
  const updateShippingInfo = (fee, province) => {
    setShippingFee(fee);
    ...
    <div style={{ ...styles.pageContainer, backgroundColor: "#FFFFFF" }}>
      ...
      <div className="flex flex-col md:flex-row max-w-[1200px] mx-auto gap-0 md:gap-5 p-0 md:p-5 bg-white text-black">
        ...
        <div className="w-full md:w-1/3">
          <OrderSummary order={order} shippingFee={shippingFee} provinceName={provinceName} />
        </div>
      </div>
    </div>
  );
