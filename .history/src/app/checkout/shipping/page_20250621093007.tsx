...
export default function ShippingPage({
  ...
  const { shippingFee, setShippingFee, setProvinceName, calculateShippingFee, formatShippingFee } = useCheckout();
  ...
  }, [selectedProvinceName, calculateShippingFee, setShippingFee, setProvinceName]);
