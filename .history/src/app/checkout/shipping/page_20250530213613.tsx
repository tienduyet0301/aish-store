  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      const orderData = {
        ...
        promoCode: savedPromoCode || null,
        promoAmount: savedPromoAmount ? parseFloat(savedPromoAmount) : 0,
        total: calculateTotal() - (savedPromoAmount ? parseFloat(savedPromoAmount) : 0),
