  ...
  return (
    <div style={styles.pageWrapper}>
      <div style={styles.container}>
        <div style={styles.headerContainer}>
          <div style={styles.headerTitle}>
            <h1 style={getMobileStyle().mainTitle}>MY ORDERS</h1>
            <div style={styles.titleUnderline}></div>
          </div>
          {Array.isArray(orders) && orders.length > 0 && (
            <p style={getMobileStyle().orderCount}>
        ...
        {!Array.isArray(orders) || orders.length === 0 ? (
          ...
          <>
              ...
              {orders.slice(0, displayCount).filter(Boolean).map((order, index) => {
                ...
                return (
                  <div key={`${order.orderCode}-${order._id || index}`} style={styles.orderCardWrapper}>
                    <div style={getMobileStyle().orderCard}>
                      <div style={getMobileStyle().orderHeader}>
                      ...
                      <div style={getMobileStyle().orderContent}>
                        <div style={styles.productsSection}>
                          <div style={styles.productsList}>
                            {order.items.map((item, itemIndex) => (
                              <div key={itemIndex} style={getMobileStyle().productItem}>
            ...
            <div style={styles.continueShopping}>
              <Link href="/products">
                <button style={getMobileStyle().continueButton}>
                  CONTINUE SHOPPING
                </button>
              </Link>
            </div>
