...
export default function CapPage() {
  ...
  const [activeButton, setActiveButton] = useState("cap");
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        if (data.ok) {
          const capProducts = data.products
  ...
  const sortOptions = [
    ...
    { value: "price-low-to-high", label: t("sortPriceLowToHigh") },
    { value: "price-high-to-low", label: t("sortPriceHighToLow") }
  ];
        ...
        <div className="px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center relative">
            <div className="inline-block">
              <button
                ref={buttonRefs.cap}
                onMouseEnter={() => handleButtonHover("cap")}
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6">
              <div className="inline-block">
                ...
                >
                  <span className="px-1">{t("filters")}</span>
                  <svg
