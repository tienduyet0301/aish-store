                ...
                <tr key={order._id + '-expand'}>
                  <td colSpan={8}>
                    <div className="bg-white border border-gray-300 rounded-lg shadow p-6 mb-2 text-sm text-gray-900">
                      ...
                      {order.paymentMethod && (
                        <div className="mb-4 border-b pb-2">
                          <b>Hình thức thanh toán:</b> {order.paymentMethod === 'cod' ? 'Thanh toán khi nhận hàng (COD)' : order.paymentMethod}
                        </div>
                      )}
                      <div className="mb-4 border-b pb-2">
                        <b>Sản phẩm:</b>
                      ...
                      {order.promoCode && (
                        <div className="mb-4 border-b pb-2">
                          <b>Mã giảm giá:</b> {order.promoCode.code} (-{order.promoAmount?.toLocaleString('vi-VN')} VND)
                        </div>
                      )}
                    </div>
                  </td>
