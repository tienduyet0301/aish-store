      ...
      <section className="py-6 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Time Frame */}
            <div className="space-y-4">
              <h2 className="text-sm font-bold uppercase tracking-wider text-black">{t('return.timeFrame.title')}</h2>
              <p className="text-xs md:text-sm leading-relaxed text-black">
                • {t('return.timeFrame.description')}
              </p>
            </div>

            {/* Shipping Fee Policy */}
            <div className="space-y-4">
              <h2 className="text-sm font-bold uppercase tracking-wider text-black">{t('return.shipping.title')}</h2>
              
              <div className="space-y-2">
                <p className="text-xs md:text-sm font-semibold text-black">{t('return.shipping.fullSupport.title')}</p>
                <ul className="text-xs md:text-sm leading-relaxed text-black space-y-1 ml-4">
                  <li>• {t('return.shipping.fullSupport.tip1')}</li>
                  <li>• {t('return.shipping.fullSupport.tip2')}</li>
                </ul>
              </div>

              <div className="space-y-2">
                <p className="text-xs md:text-sm font-semibold text-black">{t('return.shipping.halfSupport.title')}</p>
                <ul className="text-xs md:text-sm leading-relaxed text-black space-y-1 ml-4">
                  <li>• {t('return.shipping.halfSupport.tip1')}</li>
                </ul>
              </div>

              <div className="mt-4">
                <p className="text-xs md:text-sm leading-relaxed text-black italic">
                  {t('return.shipping.note')}
                </p>
              </div>
            </div>
          </motion.div>
