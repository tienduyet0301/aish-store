        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xs font-bold text-black mb-2">{t('return.shipping.fullSupport.title')}</h3>
                  <ul className="text-xs md:text-sm leading-relaxed text-black space-y-2">
                ...
                <div>
                  <h3 className="text-xs font-bold text-black mb-2">{t('return.shipping.halfSupport.title')}</h3>
                  <ul className="text-xs md:text-sm leading-relaxed text-black space-y-2">
